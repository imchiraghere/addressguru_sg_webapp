  ...
  return (
    <div className="h-full w-full  flex flex-col items-center overflow-hidden">
      <div className=" w-[80%]  bg-white">
        <div className="relative h-full overflow-hidden bg-[#FFF8F3] p-8">
          <span className="">
            <p className="font-bold text-3xl ">
              List Your Business in 2 Min{" "}
              <strong className="text-orange-500">- Absolutely Free!</strong>{" "}
            </p>
          ...
          <div>
            <div className=" mt-10 w-[350px]   2xl:scale-110  2xl:ml-10 2xl:mt-10 ">
              <RegistrationForm  setPop={setPop}/>
            </div>
          </div>
                <Image
              ...
              height={1000}
              width={1000}
              className="  w-fit h-[63%] absolute bottom-0  right-0 z-10 "
            /> 

            {/* custom orange section */}
          <div className="rounded-full h-[700px] w-[700px] absolute bg-orange-500 -right-25  top-25">
               {/* number cards around it   */}
             <span className="absolute top-20 left-2  ">
             <NumberCards img={"leads"} color={"#FFF1BF"} number={"5 Lack"} text={"Lead Generated"} />
             </span>
              <span className="absolute top-30 right-30">
             <NumberCards img={"daily-calls"} color={"#FCE1C4"} number={"10k"} text={"Direct Call Daily"} />
             </span>
              <span className="absolute -top-7 left-55">
             <NumberCards img={"verified-business"} color={"#F8D4FC"} number={"45k"} text={"Verified Business Listed"} />
             </span>
              <span className="absolute top-60 -left-7">
             <NumberCards img={"whatsapp"} color={"#C4F4D2"} number={"45k"} text={"Whatsapp Leads"} />
             </span>
              <span className="absolute top-105 -left-0">
             <NumberCards img={"live"} color={"#9FD4FF"} number={"Live"} text={"chat"} />
             </span>
      
             
            <svg
              className="absolute z-10 -top-7 right-50"
              width="180"
              height="250"
              viewBox="0 0 143 269"
              fill="none"
