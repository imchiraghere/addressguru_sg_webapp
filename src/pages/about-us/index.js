...
const AboutUs = () => {
  return (
    <div className="w-full h-full flex flex-col items-center  ">
      {/* image section */}
      <div className="w-full h-70 bg-red-200 2xl:w-[80%] relative ">
        <Image
      ...
      {/* text section */}
      <div className=" flex flex-col  bg-white  pb-15 w-full pl-15 2xl:pl-10 2xl:w-[80%] ">
        {/* about us  */}
        <Title text={"About Us"} icon={"about"} />
        <p className="text-sm font-[500] pl-1 pr-17">
        ...
        <div className="text-sm  font-[500] pl-1 pr-17">
