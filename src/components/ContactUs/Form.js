...
const Form = () => {
  return (
    <div className="bg-white pt-2 h-[30rem] w-full relative rounded-xl">

        <div className="px-5">  

       
      <h1 className="font-semibold text-lg w-full  mt-3 ">
        We'd <strong className="text-[#FF6E04]"> love </strong> to hear from
        you!
            </h1>
        <p className="  text-xs font-[500]  mb-2 lowercase ">
      ...
      <div className=" flex flex-col gap-1.5 text-sm mt-10 mr-5 text-[#323232]  ">
        <InputWithSvg
          icon={
            <svg
              width="16"
        ...
        <button className="w-[90%] bg-[#FF6E04]  rounded-md my-2 cursor-pointer  text-white font-semibold text-center py-2">
          Submit
        </button>
        </div>
      </div>

      <div className="absolute min-w-full -bottom-10 2xl:-bottom-12 rounded-xl ">
        <Image
