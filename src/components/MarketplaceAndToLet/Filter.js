      ...
      <div className="h-auto p-2 uppercase text-md mt-2 ">
        ...
        <div className="  flex flex-col gap-2 mt-3">
          ...
          <span className="flex gap-2 py-2 items-center">
            ...
            <input type="range"  className="h-[1px] bg-orange-500 cursor-pointer ml-2 t w-[65%]"/>
        ...
        <div className=" mt-7 pl-2">
          <aside className="w-full  whitespace-nowrap bg-white ">
            <h2 className="text-sm font-semibold mb-3 uppercase">Categories</h2>
            <ul className="">
              {categories.map(({ label, icon, active }) => (
                <li
                  key={label}
                  className={`flex items-center gap-2 px-1 py-2 font-semibold rounded-md text-[10px]  cursor-pointer transition ${
                    active
