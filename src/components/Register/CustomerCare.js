...
const CustomerCare = () => {
  return (
    <div className="  pb-20  w-full relative flex justify-between ">
      {/* heading and images  */}
      <div className=" relative h-full w-[600px] left-0 z-10 mt-35">
        <h3 className="text-2xl  font-bold  pl-10 ">Complete Care,</h3>
        <h3 className="text-2xl  font-bold  pl-10 "> Every Step of the Way</h3>
        {/* left images section */}
        <div className="flex flex-col mt-10 ">
          ...
          <Image
            ...
            height={500}
            width={500}
            className=" h-70 w-60 absolute right-[-25px] top-60"
          />
          <Image
            ...
            height={500}
            width={500}
            className=" z-10 w-80 h-70  relative top-25  "
          />
        </div>
      </div>

      <div className=" w-2xl max-w-3xl max-h-[800px] relative flex flex-col items-center  mt-17 ">
        <Image
        ...
        />
        <div className="flex flex-col w-auto h-auto top-14 text-white mx-auto  absolute pl-20 gap-2 ">
          ...
          <div className=" pl-20 pt-3">
            <CustomButton
              ...
              width="140px"
            />
            <h3 className="font-bold uppercase mt-10 text-lg">
